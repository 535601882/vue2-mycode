  ...
  <el-dialog title="上传图片" :visible.sync="imageUploadVisible">
    <el-form label-width="44px" label-suffix=":">
      <el-form-item label="链接">
        <el-input v-model="imageUrl" placeholder="外部图片链接" clearable></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-upload
          ...
          :headers="headers"
        >
          <el-button size="small" type="primary">将文件拖到此处，或<em>点击上传</em></el-button>
        </el-upload>
      </el-form-item>
    </el-form>
    ...
    <div slot="footer">
      ...
      <el-button @click="uploadHandler" type="primary">确定</el-button>
    </div>
  </el-dialog>
</template>
